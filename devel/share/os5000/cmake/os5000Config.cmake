...
if("TRUE" STREQUAL "TRUE")
  set(os5000_SOURCE_PREFIX /home/jihang/Documents/IGV_ws/src/os5000)
  set(os5000_DEVEL_PREFIX /home/jihang/Documents/IGV_ws/devel)
  set(os5000_INSTALL_PREFIX "")
  set(os5000_PREFIX ${os5000_DEVEL_PREFIX})
else()
  set(os5000_SOURCE_PREFIX "")
  set(os5000_DEVEL_PREFIX "")
  set(os5000_INSTALL_PREFIX /home/jihang/Documents/IGV_ws/install)
...
if(NOT "/home/jihang/Documents/IGV_ws/src/os5000/include " STREQUAL " ")
  set(os5000_INCLUDE_DIRS "")
  set(_include_dirs "/home/jihang/Documents/IGV_ws/src/os5000/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'os5000' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jihang <jihang2014@my.fit.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'os5000' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jihang/Documents/IGV_ws/src/os5000/${idir}'.  Ask the maintainer 'jihang <jihang2014@my.fit.edu>' to fix it.")
    endif()
    _list_append_unique(os5000_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "os5000")
...
set(depends "dynamic_reconfigure;roscpp;sensor_msgs;serial;tf")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${os5000_dep}_FOUND)
      find_package(${os5000_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${os5000_dep} REQUIRED ${depend_list})
  endif()
